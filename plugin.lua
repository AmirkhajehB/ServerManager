...
`شما ميتوانيد از سرور جاري خارج شويد و در هر سرور ديکري لاگين کنيد...`]]
	...
	about_key = {{{text = "Website" , url = "amir.khajeh7@gmail.com"}},{{text = "Channel" , url = "https://telegram.me/faze_shabane"}},{{text = "Robot" , url = "https://telegram.me/khajeh_amir_bot"}},{{text = "Instagram" , url = "https://instagram.com/khajeh_amir"}},{{text = "Messanger Bot" , url = "https://telegram.me/Amir_B_80_bot"}},{{text = "Admin" , url = "https://telegram.me/khajeh_amir"}}}
	about_txt = "*Server Manager Robot*\n\n   _- File manager_\n   _- SSH Terminal_\n   _- Download File_\n   _- Upload File_\n   _- Hot Keys_\n   _- & More..._\n\n`Made in Umbrella Team and Powered by shayan soft Co. Group`\nProgrammer and Idea:\n[khajeh_amir](https://instagram.com/khajeh_amir: [hadikhajeh](https://telegram.me/haditak22: [Mohammad Molla Ghasemi](https://telegram.me/wqwq2112)"
	...
	charge_key = {{{text = "Admin Contact" , url = "https://telegram.me/khajeh_amir"}},{{text = "If you'r Report, Click here" , url = "https://telegram.me/Amir_B_80_bot"}}}
	charge_txt ="Account per month is *"..nerkh.."Dollar*, tell to we for recharge\n`قیمت اکانت این ربات، ماهیانه `*"..nerkh.."0,000Rial*` میباشد، برای شارژ با ما تماس بگیرید`\n\nNumber: (+98) 911 5299755"
